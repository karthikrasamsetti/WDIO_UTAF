...
exports.config = {
  ...
  capabilities: [
    {
      ...
      "appium:appPackage": process.env.appium_webPackage,
      "appium:appActivity": process.env.appium_webActivity,
    },
  ],
  services: [
    // [
  ...
  cucumberOpts: {
    ...
    require: ["./features/step-definitions/mobile/mobile.step.js"],
